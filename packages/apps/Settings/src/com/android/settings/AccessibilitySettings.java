...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    //hackathon
    private static final String KEY_COLOR_OPTIONS="coloroptions";
    private static final String KEY_FRAME_RATE="frameoptions";
    private static final String KEY_COLOR_PICKER="colorpicker";
    private static final String KEY_COLOR_SWAPPER="colorswapper";
    // Dialog IDs.
    ...
    //hackathon
    private PreferenceScreen mColorPickerPreference;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if(key.equals(KEY_COLOR_OPTIONS)){
            DisasterModeNative.updateDMProperty("dm.colorscheme", (String)newValue);
            return true;
        }else if(key.equals(KEY_FRAME_RATE)){
            DisasterModeNative.updateDMProperty("persist.dm.framerate", (String)newValue);
            return true;
        }else if(key.equals(KEY_COLOR_SWAPPER)){
            DisasterModeNative.updateDMProperty("dm.colorscheme", (String)newValue);
            return true;
        }else{
            Log.e("Hackathon","Invalid color option");
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (mColorPickerPreference == preference){
            Intent i = new Intent (getActivity(), ColorPickerPreference.class);
            startActivity(i);
        }
    ...
    private void initializeAllPreferences() {
        ...
        //hackathon
        ListPreference colorpreference = (ListPreference)findPreference(KEY_COLOR_OPTIONS);
        colorpreference.setOnPreferenceChangeListener(this);

        ListPreference colorswapper = (ListPreference)findPreference(KEY_COLOR_SWAPPER);
        colorswapper.setOnPreferenceChangeListener(this);

        mColorPickerPreference = (PreferenceScreen)findPreference(KEY_COLOR_PICKER);
